...
Devise.setup do |config|
  ...
  # config.secret_key = '75fe4114a12ae710f21b1dc43badf505316c054b613ec42160d1382ca512e2dd795c3151b46d649f98df588c27a8e844ce7f7f63afd6b9b2667f57334902ae8d'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'support@outboundworks.com'

  # Configure the class responsible to send e-mails.
  config.mailer = 'V3Mailer'
  ...
  # config.pepper = '2456f3428aa85412ed0f21a800cdeed31789ff9992f313c9884d7a0e835cfd2dc1bfdd016ae0a7b6973f78273a498cdfe8f8b727df8111a10d2d5a0f8f7700ed'
...
Devise::TokenAuthenticatable.setup do |config|
  ...
  config.token_authentication_key = :plugin_token
